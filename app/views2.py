...
KEYCLOAK_INFO = {"CLIENT_ID": "app-vue", "CLIENT_SECRET": "fd4bf17c-3af5-41e9-8805-87bfb2a7ebec",
                 "KEYCLOAK_URI": "http://10.100.192.46:8080/auth/", "REALM": "keycloak-demo", }
...
def get_token():
    ...
    body = {"username": "editor", "password": "user"}
    data = {
        'grant_type': 'password',
        'client_id': KEYCLOAK_INFO.get("CLIENT_ID"),
        'client_secret': KEYCLOAK_INFO.get('CLIENT_SECRET'),
        'username': body['username'],
        'password': body['password']
    }
    url = ''.join([
        KEYCLOAK_INFO.get('KEYCLOAK_URI'),
        'realms/',
        KEYCLOAK_INFO.get('REALM'),
